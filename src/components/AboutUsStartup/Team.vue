      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12">
          <div class="team-content" data-aos="fade-up" data-aos-duration="1200">
            ...
            <p>Introducing the Pioneers of GharbiDev Solutions: a dynamic collective of skilled innovators, committed
              developers, and imaginative thinkers. Bound by a shared goal to transform cloud and IT solutions, our team
            ...
            <router-link to="/team" class="btn-style-one red-light-color">Meet Our Team <i
